...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="GA parameter sweep (resumable)")
    parser.add_argument("--csv", type=str, default="data/datasets/jpmf_data/Data_Graph_350.csv",
                        help="Path to CSV dataset")
    parser.add_argument("--tag", type=str, default=None, help="Optional tag for output filenames (enables clean resume per tag)")
    parser.add_argument("--inner-jobs", type=int, default=N_JOBS, help="GA scoring parallel jobs")
    parser.add_argument("--generations", type=int, default=GENERATIONS)
    parser.add_argument("--population", type=int, default=POPULATION_SIZE)
    parser.add_argument("--repeats", type=int, default=N_REPEATS)
    parser.add_argument("--hillclimb-seed", action="store_true", help="Enable hillclimb seeding")
    parser.add_argument("--score", type=str, default="bic", help="pgmpy score key (e.g., 'bic')")
